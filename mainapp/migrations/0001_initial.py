    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='mainapp.category', verbose_name='Катекория')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(blank=True, related_name='cart_product', to='mainapp.CartProduct'),
        ),
    ]
